...
Copyright (c) 2014-2015 Myriad Core Developers
...
the Myriad Core software, see http://www.myriad.org/
...
If it is a simple/trivial/non-controversial change, then one of the Myriad
...
regularly to indicate new official, stable release versions of Myriad.
