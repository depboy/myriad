...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Myriad Core"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/bitcoin_testnet"), tr("&About Myriad Core"), this);
    aboutAction->setStatusTip(tr("Show information about Myriad"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Myriad"));
...
void BitcoinGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("Myriad client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("Myriad client") + " " + tr("[testnet]"));
...
{
    QString strTitle = tr("Myriad"); // default title
