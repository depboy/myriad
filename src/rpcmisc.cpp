...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nReturn information about the given myriad address.\n"
            "\nArguments:\n"
            "1. \"myriadcoinaddress\"     (string, required) The myriad address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,            (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"myriadcoinaddress\", (string) The myriad address validated\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"myriadcoinaddress\"  (string, required) The myriad address to use for the signature.\n"
